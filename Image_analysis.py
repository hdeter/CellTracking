...
#
MaxC = 1                                # max number of fluorescence channels in image data
AIfmtInFile = '20171212_book-%s-%03d.tif'       # format string for data
